...
## 1. Shared identifiers (Phase 1.5)
...
## 2. Prior state + CI pulls (Phase 1.5)
...
## 3. Codex head guard — detach path (Phase 3)
...
## 6. Labels (Phase 5, non-self-authored only)
